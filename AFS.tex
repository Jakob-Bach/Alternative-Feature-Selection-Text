...
\begin{figure}[p]
	...
	\end{subfigure}
	\caption{
		Feature-set quality, normalized per experimental setting, over the number of alternatives, by evaluation metric and normalization method.
...
\begin{figure}[p]
	...
	\end{subfigure}
	\caption{
		Mean of feature-set quality, max-normalized per experimental setting, over the number of alternatives, by feature-selection method and evaluation metric.
...
\begin{figure}[p]
	...
	\end{subfigure}
	\caption{
		Mean of feature-set quality, normalized per experimental setting, over the number of alternatives and dissimilarity threshold~$\tau$, by evaluation metric and normalization method.
...
\begin{figure}[p]
	...
	\end{subfigure}
	\caption{
		Mean of feature-set quality, max-normalized per experimental setting, over the dissimilarity threshold~$\tau$, by feature-selection method and evaluation metric.
...
\begin{figure}[t]
	...
	\end{subfigure}
	\caption{
		Feature-set quality over feature-set size~$k$ relative to dataset dimensionality~$n$, by feature-set size~$k$ and evaluation metric.
