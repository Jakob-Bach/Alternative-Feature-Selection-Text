...
In this section, we evaluate experimental results not covered in Section~\ref{sec:afs:evaluation} since they are not directly related to the search for alternative feature sets.
In particular, we cover three experimental dimensions:
datasets (cf.~Section~\ref{sec:afs:appendix:evaluation:datasets}), evaluation metrics (cf.~Section~\ref{sec:afs:appendix:evaluation:metrics}), feature-selection methods (cf.~Section~\ref{sec:afs:appendix:evaluation:feature-selection}).
