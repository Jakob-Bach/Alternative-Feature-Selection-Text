...
Thus, when we analyzing the search for alternatives later, we will normalize feature-set quality appropriately, to compensate for the differences between datasets.
...
As we expected, the training-set objective value $Q$ of all feature sets from one search run varies more for sequential search than for simultaneous search.
...
- influence of number of alternatives (on objective and infeasibility)
- influence of FS methods and k on alternatives
...
- maybe also optimization time (depending on n, k, search method, FS method, number of alternatives)
