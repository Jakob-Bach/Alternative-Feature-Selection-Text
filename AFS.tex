...
Finding multiple useful feature set plays a role in subspace clustering~\cite{mueller2009relevant, guan2011unified} and subspace search~\cite{nguyen20134s, trittenbach2019dimension, fouche2021efficient}.
...
To obtain the initial set of feature sets, the run a feature-selection method on multiple bootstrap samples of the original dataset, as common in ensemble feature selection.
...
Instead, we provide a fixed number of alternatives.
...
TODO:
- check markdown document for further references
