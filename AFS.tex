...
\newtheorem{proposition}{Proposition} % default theorem style ("plain")
...
Assuming~$a$ to be small and independent from~$n$, i.e., $a \ll n,~a \in O(1)$, the time complexity is still polynomial in~$n$ but the exponent might be prohibitive for real-world usage.
