...
The latter is about partitioning a multiset of $n$~numbers into $a$~subsets such that the sums of all subsets are as equal as possible~\cite{korf2010objective}.
