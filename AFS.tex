...
Since \textsc{Multiprocessor Scheduling} is $\mathcal{NP}$-complete~\cite{garey2003computers} and our problem is in $\mathcal{NP}$, our problem is $\mathcal{NP}$-complete as well:
%
