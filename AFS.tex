...
In the field of XAI, finding diverse explanations is an issue, e.g., for criticisms~\cite{kim2016examples} or semifactual explanations~\cite{artelt2022even}.
...
Fostering diversity of counterfactuals is a dedicated goal~\cite{dandl2020multi, guidotti2022counterfactual, mothilal2020explaining, russell2019efficient}.
...
\begin{algorithm}[htb]
	\DontPrintSemicolon
	\KwIn{Univariate feature qualities~$q_j(\cdot)$ with $j \in \{1, \dots, n\}$, \newline
		Feature-set size~$k$, \newline
