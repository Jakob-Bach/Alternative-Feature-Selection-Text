...
In this article, we formalize the optimization problem of alternative feature selection (AFS).
Next, we propose several approaches to solve this problem exactly or heuristically.
...
In this section, we introduce our approaches for alternative feature selection.
