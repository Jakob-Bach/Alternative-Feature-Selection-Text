...
Our notion of alternative feature sets is general and thus not tailored to specific feature-selection methods.
...
The concept of alternative feature selection shares similarities with counterfactual explanations~\cite{verma2020counterfactual,stepin2021survey}, which uncover solutions for alternative predictions.
The search for counterfactual can also be formulated as an optimization problem, e.g., as an integer problem~\cite{mohammadi2021scaling} or via Satisfiability Modulo Theories (SMT)~\cite{karimi2020model}, and finding diverse counterfactuals \cite{mothilal2020explaining} is a topic as well.
