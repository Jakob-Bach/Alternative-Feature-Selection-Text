...
\end{align}
%
In the following, we formalize the notion of \emph{being alternative} in the form of constraints.
We discuss different objective functions and their consequences on solving the problem in Section~\ref{sec:approaches}.
...
The actual number of alternatives is a parameter for the user.
