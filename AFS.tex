...
\begin{algorithm}[htb]
	...
	$iters \leftarrow 1$ \tcp*{Number of feature sets evaluated}
...
- other set-distance measures and other aggregations (than "all are alternative") for multi-alternative case
