...
\subsection{Alternative-Feature-Selection Problem for Univariate Feature Qualities}
\label{sec:appendix:complete-optimization-problem}

In this section, we provide a complete specification of the alternative-feature-selection problem for sequential and simultaneous search.
