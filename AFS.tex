...
\begin{figure*}[t]
	\centering
	\subfloat[Standard deviation of objective.]{\includegraphics[width=\columnwidth, trim=0 20 0 10, clip]{plots/impact-search-stddev-objective.pdf}}
		\label{fig:impact-search-stddev-objective}
	\hfill
	\subfloat[Mean objective.]{\includegraphics[width=\columnwidth, trim=0 20 0 10, clip]{plots/impact-search-mean-objective.pdf}}
...
\begin{figure*}[t]
	\centering
	\subfloat[Max-normalization.]{\includegraphics[width=\columnwidth, trim=0 20 0 10, clip]{plots/impact-num-alternatives-objective-max.pdf}}
		\label{fig:impact-num-alternatives-objective-max}
	\hfill
	\subfloat[Min-max-normalization.]{\includegraphics[width=\columnwidth, trim=0 20 0 10, clip]{plots/impact-num-alternatives-objective-min-max.pdf}}
...
\begin{figure*}[t]
	\centering
	\subfloat[Training set.]{\includegraphics[width=\columnwidth, trim=0 10 0 10, clip]{plots/impact-num-alternatives-train-objective-tau.pdf}}
		\label{fig:impact-num-alternatives-train-objective-tau}
	\hfill
	\subfloat[Test set.]{\includegraphics[width=\columnwidth, trim=0 10 0 10, clip]{plots/impact-num-alternatives-test-objective-tau.pdf}}
