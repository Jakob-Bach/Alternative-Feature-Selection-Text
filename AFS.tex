...
\begin{figure}[htb]
	...
	\caption{Training-set objective value $Q$, normalized per experimental setting, in sequential search, using \emph{MI} as feature selector and $k=10$.
	Outliers removed for readability reasons.}
...
\begin{figure}[htb]
	...
	\end{subfigure}
	\caption{Mean objective value $Q$, max-normalized per experimental setting, in sequential search, using \emph{MI} as feature selector and $k=10$.}
