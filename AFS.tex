...
Next, prediction models may generalize better after removing irrelevant and spurious predictors.
...
For example, a feature might only show high post-hoc importance if another feature is present, due to feature interaction, but low importance else.
...
Thus, practitioners could use our generic search methods for alternatives in domain-specific case studies and interpret the resulting alternatives qualitatively.
