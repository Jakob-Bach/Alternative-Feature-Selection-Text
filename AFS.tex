...
With our experiments, we mainly focus on the trade-off between feature-set quality and obtaining alternative solutions.
...
For the tree models we use, importance expresses a feature's contribution towards optimizing the split criterion of the tree, which is Gini impurity.
...
- use mututal info are similar, as we do in filters
- are embedded (i.e., might not use all features we provide), but of course still depend on the feature sets we feed into them
