...
In contrast to the $\mathcal{NP}$-hardness results for the minimum-quality objective, the summed-quality objective (cf.~Equation~\ref{eq:afs:afs-simultaneous-sum-objective}) with univariate feature qualities and $\tau=1$ allows for polynomial-time algorithms.
In particular, the latter objective does not entail any requirements on balancing the feature sets' qualities.
...
Hence, obtaining different hardness results for the two objectives is not a contradiction.
