...
As Figure~\ref{fig:afs:impact-num-alternatives-tau-test-objective-max} displays, this phenomenon also holds for the test-set objective, though the dependency on~$\tau$ is less prominent there.
...
In contrast, if only considering valid feature sets, the mean objective can increase over the number of alternatives, as visible in Figure~\ref{fig:afs:impact-num-alternatives-tau-train-objective-max} for $\tau=1.0$ or in Figure~\ref{fig:afs:impact-num-alternatives-fs-method-train-objective-max} for \emph{MI} and \emph{Model Gain}.
...
\begin{figure}[htb]
	...
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth, trim=20 40 15 15, clip]{plots/impact-tau-fs-method-train-objective-max.pdf}
		\caption{Training-set objective value.}
	...
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth, trim=20 40 15 15, clip]{plots/impact-tau-fs-method-decision-tree-test-mcc-max.pdf}
		\caption{Test-set prediction performance.}
...
For \emph{mRMR}, the low influence os $\tau$ matches the low influence of the number of alternatives.
