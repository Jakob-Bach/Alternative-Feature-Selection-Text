...
\begin{table}[t]
	...
	\begin{tabular}{llrrrr}
		...
		Model Gain & rep. & 0.00\% & 3.60\% & 96.40\% & 0.00\% \\
...
The table shows that \emph{Greedy Replacement} more often did not find a valid alternative (3.6\%) than solver-based sequential search (1.97\%).
...
Finally, the fraction of \emph{not solved} outcomes is higher for \emph{Greedy Balancing} than for \emph{Greedy Replacement} since the latter only yields all alternatives or none, consistent to solver-based simultaneous search, while the former may also yield less alternatives than requested if it is forced to terminate early.
However, one could also easily adapt \emph{Greedy Balancing} to yield as many alternatives as feasible in cases it would have to terminate early.
